 ...
 */
final class Version20210127074652 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `admin` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, date DATETIME NOT NULL, security_token VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_880E0D76E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE beat (id INT AUTO_INCREMENT NOT NULL, genre_id INT DEFAULT NULL, beat_image_name VARCHAR(255) DEFAULT NULL, beat_name VARCHAR(255) DEFAULT NULL, titre VARCHAR(255) DEFAULT NULL, artiste VARCHAR(255) DEFAULT NULL, album VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, bpm DOUBLE PRECISION DEFAULT NULL, iframe VARCHAR(255) DEFAULT NULL, created_date DATE DEFAULT NULL, INDEX IDX_D5F9069C4296D31F (genre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE diapo (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) DEFAULT NULL, diapo_image_name VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, text LONGTEXT DEFAULT NULL, titre_fr VARCHAR(255) DEFAULT NULL, text_fr LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE licence (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) DEFAULT NULL, euro DOUBLE PRECISION DEFAULT NULL, dollar DOUBLE PRECISION DEFAULT NULL, info_1 VARCHAR(255) DEFAULT NULL, info_2 VARCHAR(255) DEFAULT NULL, info_3 VARCHAR(255) DEFAULT NULL, info_4 VARCHAR(255) DEFAULT NULL, info_5 VARCHAR(255) DEFAULT NULL, info_6 VARCHAR(255) DEFAULT NULL, color VARCHAR(255) DEFAULT NULL, titre_fr VARCHAR(255) DEFAULT NULL, info_1_fr VARCHAR(255) DEFAULT NULL, info_2_fr VARCHAR(255) DEFAULT NULL, info_3_fr VARCHAR(255) DEFAULT NULL, info_4_fr VARCHAR(255) DEFAULT NULL, info_5_fr VARCHAR(255) DEFAULT NULL, info_6_fr VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE video (id INT AUTO_INCREMENT NOT NULL, section_id INT DEFAULT NULL, titre VARCHAR(255) DEFAULT NULL, link VARCHAR(255) NOT NULL, info VARCHAR(255) DEFAULT NULL, INDEX IDX_7CC7DA2CD823E37A (section_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
