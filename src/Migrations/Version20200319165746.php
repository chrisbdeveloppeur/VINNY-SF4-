 ...
 */
final class Version20200319165746 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE genre_beat (genre_id INT NOT NULL, beat_id INT NOT NULL, INDEX IDX_6E14DF6C73694F (beat_id), INDEX IDX_6E14DF6C4296D31F (genre_id), PRIMARY KEY(genre_id, beat_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
